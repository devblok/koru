module github.com/devblok/koru

go 1.12

require (
	github.com/devblok/vulkan v0.0.0-20200418135504-3dbbc21ca777
	...
	github.com/veandco/go-sdl2 v0.0.0-20190809154531-da65661eff7f
